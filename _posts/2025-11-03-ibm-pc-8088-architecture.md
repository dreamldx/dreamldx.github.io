...
flowchart TB
    ...
    linkStyle 4,5,6,10,11,13,14,15,16,17,18 stroke:#2e7d32,stroke-width:4px,color:#000

    %% Control Path Styling (Orange - medium lines)
    linkStyle 0,1,2,3,7,8,9,12,19,20 stroke:#ff6f00,stroke-width:3px,color:#000
